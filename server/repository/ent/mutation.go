...
func (m *AuthenticationMutation) SetUsername(s string) {
	m.username = &s
}

// Username returns the value of the "username" field in the mutation.
func (m *AuthenticationMutation) Username() (r string, exists bool) {
	v := m.username
	if v == nil {
		return
	}
...
// OldUsername returns the old "username" field's value of the Authentication entity.
// If the Authentication object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthenticationMutation) OldUsername(ctx context.Context) (v string, err error) {
...
func (m *AuthenticationMutation) ResetUsername() {
	m.username = nil
}
...
func (m *AuthenticationMutation) SetPassword(b []byte) {
	m.password = &b
}

// Password returns the value of the "password" field in the mutation.
func (m *AuthenticationMutation) Password() (r []byte, exists bool) {
	v := m.password
	if v == nil {
		return
	}
...
// OldPassword returns the old "password" field's value of the Authentication entity.
// If the Authentication object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthenticationMutation) OldPassword(ctx context.Context) (v []byte, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthenticationMutation) ResetPassword() {
	m.password = nil
}
...
func (m *AuthenticationMutation) Fields() []string {
	...
	if m.username != nil {
		fields = append(fields, authentication.FieldUsername)
	}
	if m.name != nil {
		fields = append(fields, authentication.FieldName)
	}
	if m.password != nil {
		fields = append(fields, authentication.FieldPassword)
	}
	return fields
}
