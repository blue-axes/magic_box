...
func (ac *AuthenticationCreate) SetUsername(s string) *AuthenticationCreate {
...
func (ac *AuthenticationCreate) SetPassword(b []byte) *AuthenticationCreate {
...
func (ac *AuthenticationCreate) check() error {
	if _, ok := ac.mutation.Username(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`ent: missing required field "Authentication.username"`)}
	}
	if _, ok := ac.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "Authentication.name"`)}
	}
	if _, ok := ac.mutation.Password(); !ok {
		return &ValidationError{Name: "password", err: errors.New(`ent: missing required field "Authentication.password"`)}
	}
	return nil
}
